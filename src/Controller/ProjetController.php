...
class ProjetController extends AbstractController
{
    ...
    /**
     * @Route("/gerant/{nomGerant}", name="gerant")
     */
    public function gerant($nomGerant,Request $request, RestaurantRepository $repo, CommentaireRepository $repoCommentaire, UserRepository $repoClient){
        $commentaire = new commentaire();
        $restaurant = new restaurant();
        $idC = 9 ;
        $restaurant = $repo->findBy(array('gerantRestaurant' => $nomGerant));
        $comment = $repoCommentaire->findBy(array('idRestaurant' => $restaurant[0]->getId()));
        $client = $repoClient->find($idC);
        ...
        return $this->render('menu/menuGerant.html.twig',[
